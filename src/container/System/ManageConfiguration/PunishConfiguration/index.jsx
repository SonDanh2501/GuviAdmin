...
import {
  getListPunishPolicyApi,
  updatePunishPolicyApi,
} from "../../../../api/punishPolicy";
...
const PunishConfiguration = () => {
  ...
  const fetchListPunishPolicy = async (payload) => {
    try {
      ...
      const res = await getListPunishPolicyApi(
        payload.start,
        payload.length,
        payload.search
      );
  ...
  const filterContentLeft = () => {
    return (
      <ButtonCustom
        label="Tạo lệnh phạt"
        onClick={() => navigate("/configuration/punish/create")}
      />
    );
  };
                ...
                <div className="manage-punish-configuration__list--child-action-container">
                  <div className="manage-punish-configuration__list--child-action-container-icon">
                    <Tooltip placement="top" title="Chỉnh sửa">
                      <span
                        onClick={() =>
                          navigate(`/configuration/punish/edit/${el?._id}`)
                        }
                      >
...
export default PunishConfiguration;
