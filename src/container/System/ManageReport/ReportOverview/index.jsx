...
const ReportOverview = () => {
  ...
  const [typePriceService, setTypePriceService] = useState(
    configSelectTopService[0].value
  );
  ...
  const visualizationDataIncome = (data, dataInsame) => {
    ...
    const percentGrossIncome =
      (data.total[0]?.total_gross_income /
        (data.total[0]?.total_gross_income +
          dataInsame.total[0]?.total_gross_income)) *
      100;
    const percentGrossIncomeSame =
      (dataInsame.total[0]?.total_gross_income /
        (data.total[0]?.total_gross_income +
          dataInsame.total[0]?.total_gross_income)) *
      100;
    ...
    const headerTempIncome = {
      ...
      percent: Math.abs(
        (percentGrossIncome - percentGrossIncomeSame).toFixed(2)
      ),
    };
  ...
  const visualizationDataOrder = (data, dataInsame) => {
    ...
    const percentOrder =
      (data.total[0]?.total_item /
        (data.total[0]?.total_item + dataInsame.total[0]?.total_item)) *
      100;
    const percentSameOrder =
      (dataInsame.total[0]?.total_item /
        (data.total[0]?.total_item + dataInsame.total[0]?.total_item)) *
      100;
  ...
  const visualizationDataNetIncome = (data, dataInsame) => {
    ...
    const percent =
      (data.total[0]?.total_net_income /
        (data.total[0]?.total_net_income +
          dataInsame.total[0]?.total_net_income)) *
      100;
    const percentSame =
      (dataInsame.total[0]?.total_net_income /
        (data.total[0]?.total_net_income +
  ...
  const visualizationDataProfit = (data, dataInsame) => {
    ...
    setDataProfit(temp);
    const percent =
      (data.total[0]?.total_net_income_business /
        (data.total[0]?.total_net_income_business +
          dataInsame.total[0]?.total_net_income_business)) *
      100;
    const percentSame =
      (dataInsame.total[0]?.total_net_income_business /
        (data.total[0]?.total_net_income_business +
    ...
    for (let i = 0; i < arrGetResult[0].data.length; i++) {
      ...
      payload.push({
        ...
        percent_total_income: isNaN(levelPercentIncome)
          ? 0
          : levelPercentIncome,
        percent_total_net_income: isNaN(levelPercentNetIncome)
          ? 0
          : levelPercentNetIncome,
        ...
        <div className="div-flex-row-flex-start">
          <div className="block-content">
            <div className="header">
              ...
              <HeaderInfo
                total={headerIncome.total}
                arrow={headerIncome.arrow}
                percentSame={headerIncome.percent}
              />
            </div>
            <div className="content">
              {dataIncome?.length > 0 ? (
                <ResponsiveContainer height={350} width="99%">
                  <LineChart data={dataIncome} margin={{ left: -10, top: 10 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis
                      dataKey="date_report"
                      angle={-20}
          ...
          <div className="block-content">
            <div className="header">
              ...
              <HeaderInfo
                total={headerOrder.total}
                arrow={headerOrder.arrow}
                percentSame={headerOrder.percent}
              />
            </div>
            <div className="content">
              {dataOrder?.length > 0 ? (
                <ResponsiveContainer height={350} width="99%">
                  <LineChart data={dataOrder} margin={{ left: -10, top: 10 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis
                      dataKey="date_report"
                      angle={-20}
        ...
        <div className="div-flex-row-flex-start">
          <div className="block-content">
            <div className="header">
              ...
              <HeaderInfo
                total={headerNetIncome.total}
                arrow={headerNetIncome.arrow}
                percentSame={headerNetIncome.percent}
              />
            </div>
            <div className="content">
          ...
          <div className="block-content">
            <div className="header">
              ...
              <HeaderInfo
                total={headerProfit.total}
                arrow={headerProfit.arrow}
                percentSame={headerProfit.percent}
              />
            </div>
            <div className="content">
              {dataProfit?.length > 0 ? (
                <ResponsiveContainer height={350} width="99%">
                  <LineChart data={dataProfit} margin={{ left: -10, top: 10 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis
                      dataKey="date_report"
                      angle={-20}
