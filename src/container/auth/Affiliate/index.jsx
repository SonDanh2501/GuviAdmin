...
import moment from "moment";
  ...
  const LoginAffiliate = () => {
    ...
    const [valueSelectGender, setValueSelectGender] = useState("other"); // Giá trị lựa chọn giới tính
    const [valueBirthDate, setvalueBirthDate] = useState(() =>
      new Date().toISOString()
    ); // Giá trị ngày sinh
    const [valueIdentityNumber, setValueIdentityNumber] = useState(""); // Giá trị cccd
    const [valueTaxCode, setValueTaxCode] = useState(""); // Giá trị mã số thuế
    ...
    const [isShowModalCreateAccount, setIsShowModalCreateAccount] = useState(false); // Giá trị cờ hiển thị modal tạo tài khoản
    ...
    const handleCheckOTP = async (payload) => {
      try {
        ...
        if (isForgotPassword) {
          ...
          setIsShowModalCreateAccount(true);
        }
    ...
    // 5. Hàm kiểm tra đăng nhập mỗi lần vào trang login
    ...
    const handleCreateAccount = async (payload) => {
      try {
        // Step 1
        if (valueStepSignUp === 1) {
          if (
            valueFullName.trim() === "" ||
            valueEmail.trim() === "" ||
            valueIdentityNumber.trim() === ""
          ) {
            errorNotify({ message: "Vui lòng điền đẩy đủ thông tin" });
          } else {
            setValueStepSignUp(2);
          }
        }
        // Step 2
        if (valueStepSignUp === 2) {
          ...
          setIsShowModalCreateAccount(false);
          setValueStepSignUp(1);
          setValueFullName("")
          setValuePhone("")
          setValueEmail("")
          setValueIdentityNumber("")
          setValueTaxCode("")
          setValuePassword("")
            ...
            >
              ...
              <div className="login-affiliate__form--right-login-input">
                ...
                <button
                  ...
                  onClick={() =>
                    handleLoginAffiliate(valuePhone, valuePassword)
                  }
                >
                  <span>Đăng nhập</span>
                </button>
              ...
              <div className="login-affiliate__card--information-body">
                  ...
                  <>
                    ...
                    <div className="login-affiliate__card--information-body-child">
                      <div className="login-affiliate__card--information-body-child-input">
                        <InputTextCustom
                          ...
                          birthday={
                            valueBirthDate
                              ? dayjs(valueBirthDate.slice(0, 1), dateFormat)
                              : ""
                          }
                          setValueSelectedProps={setvalueBirthDate}
                        />
                      </div>
                      <div className="login-affiliate__card--information-body-child-input">
                        <InputTextCustom
                          ...
                          setValueSelectedProps={setValueSelectGender}
                          options={[
                            {
                              code: "other",
                    ...
                    <div className="login-affiliate__card--information-body-child">
                      <div className="login-affiliate__card--information-body-child-input">
                        <InputTextCustom
                          type="text"
                          value={valueIdentityNumber}
                          placeHolder="CCCD/CMND"
                          onChange={(e) =>
                            setValueIdentityNumber(e.target.value)
                          }
                          required={true}
                        />
                      </div>
                      <div className="login-affiliate__card--information-body-child-input">
                        <InputTextCustom
                          ...
                          onChange={(e) => setValueTaxCode(e.target.value)}
                        />
                      </div>
                    </div>
                    <div className="login-affiliate__card--information-body-child">
                      ...
                      <div className="login-affiliate__card--information-body-child-input">
                        <InputTextCustom
                          ...
                          searchField={true}
                          disable={
                            valueSelectProvince > 0
                              ? false
                              : valueSelectProvince?.code > 0
                              ? false
                              : valueSelectDistrict?.length > 0
                              ? false
                              : true
                          }
                ...
                {valueStepSignUp === 2 && (
                  <>
                    ...
                    <div
                      className={`login-affiliate__card--information-process-bar`}
                    >
                      <div
              ...
              <ButtonCustom
                ...
                onClick={() =>
                  handleCreateAccount({
                    ...
                    full_name: valueFullName,
                    email: valueEmail,
                    city: valueSelectProvince?.code,
                    district: valueSelectDistrict?.code,
                    gender: valueSelectGender,
                    birthday: moment(new Date(valueBirthDate)).toISOString(),
                    identity_number: valueIdentityNumber,
                    tax_code: valueTaxCode,
                    phone: valuePhone,
                    password: valuePassword,
                    code_phone_area: valuePhoneArea,
                    code: otp.join(""),
