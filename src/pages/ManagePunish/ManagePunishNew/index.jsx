...
const ManageNewPunish = () => {
  ...
  const columns = [
    ...
    {
      customTitle: <CustomHeaderDatatable title="Ngày khóa" />,
    ...
    {
      customTitle: <CustomHeaderDatatable title="Lý do khóa" />,
    ...
    {
      customTitle: (
        <CustomHeaderDatatable title="Thời gian còn lại" position="center" />
      ),
  ...
  const [listData, setListData] = useState([
    ...
    },
    {
      ...
      execution_date: "2025-03-11T09:44:40.583Z",
      id_collaborator: {
    ...
    },
    {
      ...
      execution_date: "2025-03-16T09:44:40.583Z",
      id_collaborator: {
...
export default ManageNewPunish;
