...
import { getCollaborators, getType, createCollaborator, updateCollaborator } from '../actions/collaborator';

export default function CollaboratorsReducers(state = INIT_STATE.collaborators, action) {
  switch (action.type) {
    ...
    case getType(updateCollaborator.updateCollaboratorSuccess):
      return {
        ...
        collaborator._id === action.payload._id ? action.payload : collaborator
        ),
      };
    default:
      return state;
